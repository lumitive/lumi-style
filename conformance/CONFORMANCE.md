...
# LUMI style conformance · skill 0.1.622 · newest run 0.1.605 · 17 releases behind

Runs `~/Documents/LUMI-Style/_conformance/0.1.605-2026-08-26` · run 2026-08-26 · darwin · 4 of 12 agents detected · up to n=1 per agent · 3 of 12 can never answer a CLI probe

| agent | capability | cli | model | T1-deck | T2-deaify | T3-recall | verdict |
|---|---|---|---|---|---|---|---|
| Claude Code | full | 2.1.245 (Claude Code) | claude-opus-5[1m] | not earned | pass | pass | **partial: 2 of 3 earned, all pass** |
| Gemini CLI | full | 0.56.0 | unconfirmed | not earned | not earned | not earned | **run, nothing earned: 3 of 3 attempted** |
| OpenAI Codex | full | — | — | — | — | — | **not installed** |
| Cursor | full | 2026.08.11-e8db854 | Auto | fail: D19_vocabulary=FAIL, design exited 1 (14 held) | pass | pass | **fail** |
...
| Hermes | full | Hermes Agent v0.20.5 (2026.8.19) · upstr | unconfirmed | not earned | pass | not earned | **partial: 1 of 3 earned, all pass** |
...
* `claude-code/T1-deck` · **not earned** · the driver reports 'over budget' after 3601.5s — whatever it left behind is a draft, and a draft is not a result
* `cursor/T1-deck` · **fail** · design exited 1, D19_vocabulary=FAIL
* `gemini-cli/T1-deck` · **not earned** · the driver reports 'driver failed' after 14.1s — whatever it left behind is a draft, and a draft is not a result
* `gemini-cli/T2-deaify` · **not earned** · the driver reports 'driver failed' after 8.0s — whatever it left behind is a draft, and a draft is not a result
* `gemini-cli/T3-recall` · **not earned** · the driver reports 'driver failed' after 16.1s — whatever it left behind is a draft, and a draft is not a result
* `hermes/T1-deck` · **not earned** · the driver reports 'misplaced': the artifact was written to ~/deck.en.html, outside the working directory, and is not scored from there
* `hermes/T3-recall` · **not earned** · the driver reports 'misplaced': the artifact was written to ~/answers.md, outside the working directory, and is not scored from there
