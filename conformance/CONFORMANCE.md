...
# LUMI style conformance · skill 0.1.610 · newest run 0.1.605 · 5 releases behind
...
| Gemini CLI | full | 0.56.0 | (the CLI's default) | not earned | not earned | not earned | **not run** |
