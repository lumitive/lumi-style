...
# LUMI style conformance · skill 0.1.646 · newest run 0.1.641 · 5 releases behind

Runs `~/Documents/LUMI-Style/_conformance/0.1.641-2026-08-28` · run 2026-08-28 · darwin · 4 of 12 agents detected · up to n=1 per agent · 3 of 12 can never answer a CLI probe

| agent | capability | cli | model | T1-deck | T2-deaify | T3-recall | verdict |
|---|---|---|---|---|---|---|---|
| Claude Code | full | 2.1.250 (Claude Code) | claude-opus-5 (asked opus) | not earned | pass | pass | **partial: 2 of 3 earned, all pass** |
| Gemini CLI | full | 0.56.0 | — | not run | not run | not run | **not run** |
| OpenAI Codex | full | — | — | — | — | — | **not installed** |
| Cursor | full | 2026.08.25-3e8eec8 | Cursor Grok 4.6 High | pass (15 held) | pass | pass | **pass** |
...
* `claude-code/T1-deck` · **not earned** · the driver reports 'over budget' after 3600.9s — whatever it left behind is a draft, and a draft is not a result
