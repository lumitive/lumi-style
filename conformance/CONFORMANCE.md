...
# LUMI style conformance · skill 0.1.613 · newest run 0.1.605 · 8 releases behind
...
|---|---|---|---|---|---|---|---|
| Claude Code | full | 2.1.245 (Claude Code) | (the CLI's default) | not earned | pass | pass | **partial: 2 of 3 earned, all pass** |
| Gemini CLI | full | 0.56.0 | (the CLI's default) | not earned | not earned | not earned | **run, nothing earned: 3 of 3 attempted** |
| OpenAI Codex | full | — | — | — | — | — | **not installed** |
| Cursor | full | 2026.08.11-e8db854 | (the CLI's default) | pass (14 held) | pass | pass | **pass** |
...
| Hermes | full | Hermes Agent v0.20.5 (2026.8.19) · upstr | (the CLI's default) | not earned | pass | not earned | **partial: 1 of 3 earned, all pass** |
