...
# LUMI style conformance · skill 0.1.523

Runs `conformance/results/latest` · darwin · 2 of 12 agents detected · up to n=1 per agent · 4 of 12 can never answer a CLI probe

| agent | capability | cli | T1-deck | T2-deaify | T3-recall | verdict |
|---|---|---|---|---|---|---|
| Claude Code | full | 2.1.231 (Claude Code) | not earned | pass | pass | **partial: 2 of 3 driven, all pass** |
