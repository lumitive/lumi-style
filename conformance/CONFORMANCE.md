...
# LUMI style conformance · skill 0.1.602 · newest run 0.1.578 · 3 releases behind

Runs `~/Documents/LUMI-Style/_conformance/0.1.578-2026-08-23` · run 2026-08-23 · darwin · 4 of 12 agents detected · up to n=1 per agent · 3 of 12 can never answer a CLI probe

| agent | capability | cli | model | T1-deck | T2-deaify | T3-recall | verdict |
|---|---|---|---|---|---|---|---|
| Claude Code | full | 2.1.238 (Claude Code) | (the CLI's default) | pass | pass | pass | **pass** |
...
* `gemini-cli/T1-deck` · **not earned** · the driver reports 'driver failed' after 381.7s — whatever it left behind is a draft, and a draft is not a result
* `gemini-cli/T2-deaify` · **not earned** · the driver reports 'driver failed' after 15.1s — whatever it left behind is a draft, and a draft is not a result
* `gemini-cli/T3-recall` · **not earned** · the driver reports 'driver failed' after 17.1s — whatever it left behind is a draft, and a draft is not a result
* `hermes/T1-deck` · **not earned** · the driver reports 'stall' after 1854.3s — whatever it left behind is a draft, and a draft is not a result
