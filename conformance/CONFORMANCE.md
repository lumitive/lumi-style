...
# LUMI style conformance · skill 0.1.634 · newest run 0.1.623 · 11 releases behind

Runs `~/Documents/LUMI-Style/_conformance/r17-0.1.623` · run 2026-08-27 · darwin · 4 of 12 agents detected · up to n=1 per agent · 3 of 12 can never answer a CLI probe

| agent | capability | cli | model | T1-deck | T2-deaify | T3-recall | verdict |
|---|---|---|---|---|---|---|---|
| Claude Code | full | 2.1.247 (Claude Code) | claude-opus-5 (asked opus) | not earned | pass | pass | **partial: 2 of 3 earned, all pass** |
...
| Cursor | full | 2026.08.25-3e8eec8 | Cursor Grok 4.6 High (asked cursor-grok-4.6-high), Cursor Grok 4.6 (asked cursor-grok-4.6-high) | pass (15 held) | pass | pass | **pass** |
...
| Hermes | full | Hermes Agent v0.20.5 (2026.8.19) · upst… | unconfirmed | not earned | pass | not earned | **partial: 1 of 3 earned, all pass** |
...
* `claude-code/T1-deck` · **not earned** · the driver reports 'driver failed' after 1795.4s — whatever it left behind is a draft, and a draft is not a result
* `gemini-cli/T1-deck` · **not earned** · the driver reports 'driver failed' after 86.6s — whatever it left behind is a draft, and a draft is not a result
* `gemini-cli/T2-deaify` · **not earned** · the driver reports 'driver failed' after 11.1s — whatever it left behind is a draft, and a draft is not a result
* `gemini-cli/T3-recall` · **not earned** · the driver reports 'driver failed' after 14.1s — whatever it left behind is a draft, and a draft is not a result
