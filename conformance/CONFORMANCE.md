...
# LUMI style conformance · skill 0.1.628 · newest run 0.1.626 · 2 releases behind

Runs `~/Documents/LUMI-Style/_conformance/r19-xhigh-3` · run 2026-08-27 · darwin · 4 of 12 agents detected · up to n=1 per agent · 3 of 12 can never answer a CLI probe

| agent | capability | cli | model | T1-deck | T2-deaify | T3-recall | verdict |
|---|---|---|---|---|---|---|---|
| Claude Code | full | 2.1.247 (Claude Code) | — | not run | not run | not run | **not run** |
| Gemini CLI | full | 0.56.0 | — | not run | not run | not run | **not run** |
| OpenAI Codex | full | — | — | — | — | — | **not installed** |
| Cursor | full | 2026.08.25-3e8eec8 | Cursor Grok 4.6 Extra High (asked cursor-grok-4.6-xhigh) | pass (15 held) | not run | not run | **partial: 1 of 3 earned, all pass** |
...
| Hermes | full | Hermes Agent v0.20.5 (2026.8.19) · upstr | — | not run | not run | not run | **not run** |
