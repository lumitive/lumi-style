...
# LUMI style conformance · skill 0.1.529 · newest run 0.1.522 · 5 releases behind

Runs `conformance/results/latest` · run 2026-08-19 · darwin · 2 of 12 agents detected · up to n=1 per agent · 4 of 12 can never answer a CLI probe

| agent | capability | cli | T1-deck | T2-deaify | T3-recall | verdict |
|---|---|---|---|---|---|---|
| Claude Code | full | 2.1.237 (Claude Code) | not earned | pass | pass | **partial: 2 of 3 driven, all pass** |
...
* `claude-code/T1-deck` · **not earned** · the driver reports 'timeout' after 900.0s — whatever it left behind is a draft, and a draft is not a result
