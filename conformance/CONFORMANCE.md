...
# LUMI style conformance · skill 0.1.625 · newest run 0.1.623 · 2 releases behind
...
|---|---|---|---|---|---|---|---|
| Claude Code | full | 2.1.245 (Claude Code) | claude-opus-5 (asked opus) | not earned | pass | pass | **partial: 2 of 3 earned, all pass** |
