...
# LUMI style conformance · skill 0.1.541 · newest run 0.1.539 · 1 release behind

Runs `conformance/results/0.1.539-2026-08-21` · run 2026-08-21 · darwin · 3 of 12 agents detected · up to n=1 per agent · 4 of 12 can never answer a CLI probe

| agent | capability | cli | model | T1-deck | T2-deaify | T3-recall | verdict |
|---|---|---|---|---|---|---|---|
| Claude Code | full | 2.1.237 (Claude Code) | (the CLI's default) | fail: collision=FAIL, layout exited 1 | pass | pass | **fail** |
