...
# LUMI style conformance · skill 0.1.609 · newest run 0.1.605 · 4 releases behind
...
|---|---|---|---|---|---|---|---|
| Claude Code | full | 2.1.245 (Claude Code) | (the CLI's default) | not earned | pass | pass | **partial: 2 of 3 driven, all pass** |
...
| Hermes | full | Hermes Agent v0.20.5 (2026.8.19) · upstr | (the CLI's default) | not earned | pass | not earned | **partial: 1 of 3 driven, all pass** |
