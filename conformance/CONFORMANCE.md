...
# LUMI style conformance · skill 0.1.563

Runs `/Users/he123/Documents/LUMI-Style/_conformance/r16-pinned` · run 2026-08-22 · darwin · 4 of 12 agents detected · up to n=1 per agent · 3 of 12 can never answer a CLI probe

| agent | capability | cli | model | T1-deck | T2-deaify | T3-recall | verdict |
|---|---|---|---|---|---|---|---|
| Claude Code | full | 2.1.238 (Claude Code) | opus | not earned | pass | pass | **partial: 2 of 3 driven, all pass** |
| Gemini CLI | full | 0.56.0 | — | not run | not run | not run | **not run** |
| OpenAI Codex | full | — | — | — | — | — | **not installed** |
| Cursor | full | 2026.08.11-e8db854 | cursor-grok-4.6-xhigh | pass | pass | pass | **pass** |
...
| Hermes | full | Hermes Agent v0.20.5 (2026.8.19) · upstr | deepseek-v4-flash | not earned | not run | not run | **not run** |
...
* `claude-code/T1-deck` · **not earned** · the driver reports 'over budget' after 3600.8s — whatever it left behind is a draft, and a draft is not a result
* `hermes/T1-deck` · **not earned** · the driver reports 'misplaced': the artifact was written to /Users/he123/deck.en.html, outside the working directory, and is not scored from there
