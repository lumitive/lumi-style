...
TRUSTED_CLOSURE=("$SCRIPT_DIR/../lib/color_math.py" "$SCRIPT_DIR/../lib/css_tokens.py" "$SCRIPT_DIR/../lib/lock.py" "$SCRIPT_DIR/../lib/trace_schema.py" "$SCRIPT_DIR/../lib/deliverable_registry.py" "$SCRIPT_DIR/review_scores.py")
UNLOCKED=0
RESTORE_FAILED=0
WORK=""
