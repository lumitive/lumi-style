...
cannot be checked, and drifts the moment someone nudges a point.
    ...
    python3 scripts/build/build_geography.py           # write both SVGs
    python3 scripts/build/build_geography.py --check   # verify they are current
...
def globe():
    ...
    L = [f'<svg xmlns="http://www.w3.org/2000/svg" viewBox="-12 -12 {size + 24:.0f} '
         ...
         "<!-- generated by scripts/build/build_geography.py; edit the coordinates there -->",
