...
"""Generate the trade-bloc registry from the bloc memberships.
    ...
    python3 scripts/build/build_trade_registry.py            # write
    python3 scripts/build/build_trade_registry.py --check    # verify current (CI)
...
def build():
    ...
    return {
        "schema": 1,
        "$comment": (
            "GENERATED by scripts/build/build_trade_registry.py — do not edit, run the "
