...
def render(reg=None, prefix=None):
    ...
    lines += [
        ...
        " * behind them is not. */",
        "/* THE AXIS AND ITS REFERENCE. The obliquity has been in the",
        " * transform since 0.1.397 and invisible for as long, because a sphere",
        " * is rotationally symmetric and a rotated drawing of one has nothing",
        " * to be rotated against. These two lines are that something: the",
        " * spindle and the stand. */",
        ".gl-axis { stroke: var(--tx3); stroke-width: 2; stroke-linecap: round; }",
        ".gl-axis-ref { stroke: var(--ln1); stroke-width: 1.5; "
