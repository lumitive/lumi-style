...
# The ripple ground, defined once and instantiated per page with <use>. Since
# the seigaiha upgrade it is generated by build_seigaiha.py — same contract as
# the sixteen polylines it replaces (uncountable, below the waterline, token
# colours, byte-stable), one authority instead of a private copy here.
from build_seigaiha import ground_defs
