...
> **lumi-style 0.1.445.** This file points at the skill; it does not restate it. The rules live in [`SKILL.md`](SKILL.md) and [`references/`](references/), and on any conflict those win.
